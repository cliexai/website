    ...
    <div className="min-h-screen bg-white dark:bg-[#0c0c0c] text-black dark:text-white flex flex-col md:flex-row font-sans selection:bg-brand/30 relative">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-24 py-12 z-10 relative border-r border-black/5 dark:border-white/5">
        <div className="max-w-md w-full mx-auto">
          ...
          {/* Social Auth */}
          <button className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-[#121212] hover:bg-black/5 dark:hover:bg-white/5 transition-all font-semibold text-sm mb-6 shadow-sm active:scale-[0.98]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="space-y-1.5 flex-1">
                ...
                <div className="flex bg-black/5 dark:bg-[#161616] border border-black/10 dark:border-white/5 rounded-xl focus-within:ring-2 focus-within:ring-brand/50 focus-within:border-brand/50 transition-all relative">
                  ...
                  <input required type="tel" placeholder="(555) 000-0000" className="w-full bg-transparent px-3 py-3 text-sm focus:outline-none placeholder:text-black/30 dark:placeholder:text-white/30" />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <input required type="email" placeholder="john@example.com" className="w-full bg-black/5 dark:bg-[#161616] border border-black/10 dark:border-white/5 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand/50 focus:border-brand/50 transition-all placeholder:text-black/30 dark:placeholder:text-white/30" />
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="space-y-1.5 flex-1 relative">
                ...
                <div className="relative">
                  <input required type={showConfirm ? 'text' : 'password'} placeholder="••••••••" className="w-full bg-black/5 dark:bg-[#161616] border border-black/10 dark:border-white/5 rounded-xl pl-4 pr-10 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand/50 focus:border-brand/50 transition-all placeholder:text-black/30 dark:placeholder:text-white/30" />
            ...
            <button type="submit" disabled={isLoading} className="w-full mt-4 bg-brand hover:bg-brand-light text-white font-semibold py-3.5 rounded-xl transition-all shadow-[0_0_20px_rgba(139,92,246,0.3)] hover:shadow-[0_0_30px_rgba(139,92,246,0.5)] active:scale-[0.98] flex items-center justify-center">
